...
export default function HomeSection() {
    return (
        <section className="max-w-screen max-h-screen py-1 md:px-5 border  ">
            <div className=" py-5 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-gray-50 mx-5">
                <div className="md:flex items-center justify-between w-full bg-gray-50  ">
                    <div className="xl:w-4/6 md:w-1/2 w-full xl:pr-24 ">
                        {/* <p
                            role="contentinfo"
                            className=" focus:outline-none text-base leading-6 mb-8 text-gray-600 md:mt-0 mt-10"
                        >
                            “Don’t get carried away with super-short paragraphs.
                            The secret to one-sentence paragraphs is to use them
                            like a spice: A pinch of cumin can make a meal more
                            savory, but I don’t want to eat a plateful of the
                            stuff.”
                        </p> */}
                    ...
                    <div className="xl:w-1/3 md:w-1/2 w-full">
                        ...
                        >
                            We take care to overcome our expectations and offer
                            you excellence and perfection in every case we
                            produce. We provide a nange services to help you
                            plan everything from start to finish and take the
                            stress away from you. We work with you personally
                            and professionally. Organizing events is our life
                            and we love what we do.
                        </p>
                        <div className="mt-10">
                            <Link
                                href="#services"
                                className="flex items-center md:p-3 p-1 focus:outline-none text-xl font-medium leading-5 text-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700"
                            >
                                Our Services
                                <svg
                                    className="ml-8"
