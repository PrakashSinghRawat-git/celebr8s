            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    <div className="hidden sm:flex flex-row items-center space-x-6">
                        ...
                        <svg
                            className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer hover:scale-105  "
                            width={24}
                            height={24}
                            viewBox="0 0 24 24"
                            fill="none"
                    ...
                    <div className="hidden sm:flex flex-row space-x-4">
                        <p className="cursor-pointer   hover:scale-102 hover:text-sky-700  ">
                            Home
                        </p>
                        <p className="cursor-pointer   hover:scale-102 hover:text-sky-700  ">
                            About
                ...
                >
                    <div className="flex  justify-center gap-4 mt-4 w-80 mx-auto   mb-5  flex-wrap ">
                        <p>Home</p>
                        <p>About</p>
                        <p>Services</p>
                        <p>Contact</p>
